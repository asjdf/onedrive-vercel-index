...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'homeboyc@4vhy6v.onmicrosoft.com',
  ...
  email: 'mailto:homeboyc@foxmail.com',
